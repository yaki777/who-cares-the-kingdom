...
ROLE_QUEEN = Role('queen', '王后', '你的国家面临着前所未有的危机。你的丈夫已经亲临前线，在后方的你必须做点什么来拯救这个岌岌可危的国家。', (12, 12),
                  {
                      "pg1": 0.1,
                      "pc1": 0.1,
                      "ph1": 0.1,
...
ROLE_PRINCESS = Role('princess', '公主', '你听说邻国入侵了你的国家，你的父亲亲临前线，母亲四处求援。也许你也能做点什么...(尚未开发)', (6, 10),
                     {
                         "pg1": 0.1,
                         "pc1": 0.1,
                         "ph1": 0.1,
...
ROLE_KNIGHT = Role('knight', '骑士', '你是国家的骑士，你的国家正面临前所未有的危机。你马上就要奔赴前线，在那之前你还可以做点准备...(尚未开发)', (11, 11),
                   {
                       "pg1": 0.1,
                       "pc1": 0.1,
                       "ph1": 0.1,
...
ROLE_ADVENTURER = Role('adventurer', '冒险家', '你是一个冒险家，你只是暂住在这个国家。你听说这个国家遭遇了邻国的入侵，也许你应该帮助它。当然这都是你自己的选择...(尚未开发)', (2, 11),
                       {
                           "g1": 2,
                           "t1": 0.5,
                           "m1": 0.5,
...
ROLE_NUN = Role('nun', '修女', '你是教会的修女。你听说这个国家遭遇了邻国的入侵。你还挺喜欢这里的，也许你可以请教会帮个忙...(尚未开发)', (6, 10),
                {
                    "m1": 1,
                    "ra1": 1,
                    "cs1": 1,
...
ROLE_PROSTITUTE = Role('prostitute', '娼妓', '你只是被抓到这个国家的妓女。你听说这个国家遭遇了邻国的入侵。你有点害怕，你不知道自己能做什么。但是命运啊...(尚未开发)', (2, 3),
                       {
                           "m1": 1,
                           "ra1": 1,
                           "t1": 1
