...
class Area:
    def __init__(self, code, level, name, description, links):
        ...
        self.links = links
    def card(self):
        return Card(self.level, "Pikes", self.code, self.name, self.description, self, False)


AREA_MAP = {
    "uk": Area("uk", 14, "未知区域", "NPC的默认位置，你不应该看到这段话", []),
    "g1": Area("g1", 2, "城门", "走出去就到了城外", ["cs1"]),
    "mg1": Area("mg1", 6, "魔法师工会", "这里是魔法师工会，是魔法师们交流的地方", ["cs1"]),
    "ag1": Area("ag1", 6, "冒险者公会", "这里是冒险者公会，是冒险者们交流的地方", ["cs1"]),
    "m1": Area("m1", 2, "市场", "这里是市场，是城市的交易中心", ["cs1"]),
    "t1": Area("t1", 2, "酒馆", "这里是酒馆，是城市的休闲场所", ["cs1"]),
    "l1": Area("l1", 4, "图书馆", "这里是图书馆，是城市的知识中心", ["cs1"]),
    "c1": Area("c1", 4, "教会", "这里是教会，是城市的信仰中心", ["cs1"]),
    "ra1": Area("ra1", 2, "住宅区", "这里是住宅区，是城市的居住地", ["cs1"]),
    "ura1": Area("ura1", 6, "贵族区", "这里是贵族区，是城市的富人区", ["cs1"]),
    "mc1": Area("mc1", 10, "骑士团兵营", "这里是骑士团的兵营", ["cs1"]),
    "cs1": Area("cs1", 2, "中央广场", "这里是城市的中央广场，人来人往，热闹非凡",
                ["g1", "mg1", "ag1", "m1", "t1", "l1", "c1", "ra1", "ura1", "mc1", "pg1"]),
