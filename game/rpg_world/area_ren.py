...
AREA_MAP = {
    ...
    "ra1": Area("ra1", 2, "下城区", "这里是下城区，是城市的居住地", ["cs1", "c1", "al1"]),
    'al1': Area("al1", 2, "炼金实验室", "这里是炼金实验室，是炼金师们的工作地", ["ra1"]),
    "ura1": Area("ura1", 6, "上城区", "这里是上城区，是城市的富人区", ["mc1", "l1", "cs1"]),
    "mc1": Area("mc1", 10, "骑士团兵营", "这里是骑士团的兵营", ["ura1"]),
    "cs1": Area("cs1", 2, "中央广场", "这里是城市的中央广场，人来人往，热闹非凡",
                ["ra1", "ura1", "m1", "pg1"]),
    "pg1": Area("pg1", 7, "王宫大门", "王宫的大门，有一些守卫站着", ["cs1", "pc1"]),
    "pc1": Area("pc1", 8, "内院", "王宫的内院，有一些花草树木", ["pg1", "ph1"]),
    "ph1": Area("ph1", 8, "大厅", "王宫的大厅，有一些士兵在巡逻",
                ["pc1", "pbh1", "pb1", "ps1", "psr1", "kbr1", "pbr1_0", "pbr1_1"]),
    "pbh1": Area("pbh1", 9, "宴会厅", "王宫的宴会厅，有一些贵族在聚会", ["ph1"]),
    "pb1": Area("pb1", 9, "后院", "王宫的后院，有一些宠物在玩耍", ["ph1"]),
    "ps1": Area("ps1", 9, "书房", "王宫的书房，有一些书籍", ["ph1"]),
    "psr1": Area("psr1", 13, "密室", "王宫的密室，有一些宝藏", ["ph1"]),
